...
<body>
	...
	<form name="userForm" action="user-edit" method="post">
		...
		<table>
			...
			<tr id="email">
				<td>eMail:</td>
				<td><input type="text" name="email" placeholder="<c:out value="${user.email}"></c:out>"></td>
				<td><span class="msg"></span></td>
			</tr>
			<tr id="balance">
				<td>Balance:</td>
				<td><input type="text" name="email" placeholder="<c:out value="${user.balance}"></c:out>"></td>
				<td><span class="msg"></span></td>
			</tr>
			<%-- 
			<tr id="roleId">
				<td>Role:</td>
				<td><input type="text" name="email" placeholder="<c:out value="${user.roleId}"></c:out>"></td>
				<td><span class="msg"></span></td>
			</tr>
			 --%>
			<tr id="password">
